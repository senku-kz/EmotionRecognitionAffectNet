...
def create_plot(model_dst, model_name='CoAtNet', type='final'):
    steps = ['train', 'valid']
...
if __name__ == '__main__':
    # create_plot(model_dst, model_name='CoAtNet')
    # create_plot(model_dst, model_name='VGG')
    create_plot(model_dst, model_name='ResNet')
    pass
